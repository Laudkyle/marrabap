...
const BalanceSheet = () => {
  ...
  const netIncome =
    calculateTotal(balanceSheetData.revenue) -
    calculateTotal(balanceSheetData.expense);
  ...
  const totals = {
    ...
    totalEquity: calculateTotal(balanceSheetData.equity) + netIncome, // Add net income to equity
  };
        ...
        <div className="p-4 md:p-6 lg:p-8">
          ...
          <div>
            ...
            <div className="overflow-x-auto">
              ...
              {/* Net Income Row */}
              <div className="flex items-center py-3 border-t border-gray-300 px-2 md:px-4">
                <span className="flex-1 text-sm md:text-base font-semibold text-gray-800">
                  Net Income
                </span>
              ...
              <div className="flex items-center py-4 mt-6 border-t-2 border-gray-300 px-2 md:px-4">
                ...
                <span className="text-base md:text-lg font-semibold text-gray-900">
                  {formatCurrency(totals.totalLiabilities + totals.totalEquity)}
                </span>
              </div>
            </div>
          </div>
